...
func (daemon *Daemon) injectSuseSecretStore(c *container.Container) error {
	// We need to drop any "old" SUSE secrets. daemon.containerStart already
	// does this for us, but include it here just in case. See bsc#1057743 and
	// bsc#1244035 for details on why this is necessary could cause issues.
